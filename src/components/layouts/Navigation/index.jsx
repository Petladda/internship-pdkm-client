...
const NavigationMenu = () => {
  return (
    <section
      ...
      className="block sticky  z-10 bg-primary shadow opacity-75 rounded-t-[40px] w-full h-20 mx-auto  "
    >
      <div id="tabs" className="w-full flex justify-between  text-white  ">
        <a
          href="#"
          className="w-full   focus:text-secondary hover:text-secondary justify-center inline-block text-center pt-5 pb-1"
        >
          <svg
            width="25"
            height="25"
          ...
          <Link href="/OTrequest" className="tab tab-home block text-xs">ขอฟอร์ม OT</Link>
        </a>
        ...
        >
          ...
          <span className="tab tab-explore block text-xs">สถานะ</span>
        </a>
        <a
          href="#"
          className="w-full focus:text-secondary hover:text-secondary justify-center inline-block text-center pt-5 pb-1"
        >
          ...
          <span className="tab tab-whishlist block text-xs">โปรไฟล์</span>
        </a>
